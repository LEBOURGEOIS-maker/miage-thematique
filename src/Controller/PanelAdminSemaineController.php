...
class PanelAdminSemaineController extends AbstractController
{
  public function panelAdminSemaine(EntityManagerInterface $em, Request $request, $dateD, $dateF)
  {
    ...
    return $this->render('panelAdminSemaine.html.twig', array('formPointage' => $formPointage->createView(),

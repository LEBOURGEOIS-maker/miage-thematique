...
class PanelAdminAnomalieController extends AbstractController
{
  public function panelAdminAnomalie(EntityManagerInterface $em, Request $request)
  {
    ...
    return $this->render('panelAdminAnomalie.html.twig', array('formPointage' => $formPointage->createView(),

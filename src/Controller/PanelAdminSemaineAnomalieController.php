...
class PanelAdminSemaineAnomalieController extends AbstractController
{
  public function panelAdminSemaineAnomalie(EntityManagerInterface $em, Request $request, $dateD, $dateF)
  {
    $dateDebut = new \DateTime();
    $dateFin = new \DateTime();
    $dateDebut = $dateDebut->setTimestamp(strtotime(str_replace('.', '-', $dateD).' midnight'));
    $dateFin = $dateFin->setTimestamp(strtotime(str_replace('.', '-', $dateF).' 23:59:59'));
    ...
    return $this->render('panelAdminSemaineAnomalie.html.twig', array('formPointage' => $formPointage->createView(),

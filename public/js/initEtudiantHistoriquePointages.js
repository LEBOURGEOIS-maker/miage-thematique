...
$(document).ready(function() {
  ...
  $('#tableauEtudiantHisto thead tr').clone(true).appendTo( '#tableauEtudiantHisto thead' );
  $('#tableauEtudiantHisto thead tr:eq(1) th').each( function (i) {
      var title = $(this).text();
  ...
  var table = $('#tableauEtudiantHisto').DataTable( {
      // dom: '<lf<t>ip>',
      orderCellsTop: true,
      fixedHeader: true,
      dom: 'lBtip',

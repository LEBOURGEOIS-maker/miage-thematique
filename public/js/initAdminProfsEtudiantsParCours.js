...
$(document).ready(function() {
  ...
  $('#tableauProfs thead tr').clone(true).appendTo( '#tableauProfs thead' );
  $('#tableauProfs thead tr:eq(1) th').each( function (i) {
      var title = $(this).text();
  ...
  var table = $('#tableauProfs').DataTable( {
      // dom: '<lf<t>ip>',
      orderCellsTop: true,
      fixedHeader: true,
      dom: 'lBtip',
...
$(document).ready(function() {
  ...
  $('#tableauEtudiants thead tr').clone(true).appendTo( '#tableauEtudiants thead' );
  $('#tableauEtudiants thead tr:eq(1) th').each( function (i) {
      var title = $(this).text();
      $(this).html( '<input class="form-control form-control-sm" type="text" placeholder="Filtrer" />' );
  ...
  var table = $('#tableauEtudiants').DataTable( {
      // dom: '<lf<t>ip>',
      orderCellsTop: true,
      fixedHeader: true,
      dom: 'lBtip',

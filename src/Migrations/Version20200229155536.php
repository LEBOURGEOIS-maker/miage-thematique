 ...
 */
final class Version20200229155536 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cours CHANGE id id INT AUTO_INCREMENT NOT NULL, ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE pointage CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE date_pointage_entree date_pointage_entree DATETIME DEFAULT NULL, CHANGE date_pointage_sortie date_pointage_sortie DATETIME DEFAULT NULL, CHANGE utilisateur_etudiant_id utilisateur_etudiant_id INT DEFAULT NULL, CHANGE commentaire commentaire VARCHAR(255) DEFAULT NULL, CHANGE commentaire_sortie commentaire_sortie VARCHAR(255) DEFAULT NULL, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pointage MODIFY id INT NOT NULL');

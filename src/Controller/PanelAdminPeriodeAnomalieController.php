...
class PanelAdminPeriodeAnomalieController extends AbstractController
{
  public function panelAdminPeriodeAnomalie(EntityManagerInterface $em, Request $request, $dateD, $dateF)
  {
    ...
    return $this->render('panelAdminPeriodeAnomalie.html.twig', array('formPointage' => $formPointage->createView(),
